...
if __name__=="__main__":
    asst1=lab_asst("Kiran",date(1994,7,24),"Computer","e001",50000,["b1","b2"])
    asst2=lab_asst("Ajay",date(1996,11,20),"IT","e002",50000,["b3","b2"])
    fac1=faculty("ABC",date(1984,9,10),"Computer","e003",100000,"DAA",1,"M.Tech")
    fac2=faculty("DEF",date(1980,4,30),"IT","e004",120000,"DLD",2,"M.E.")
    ...
    stud1=student("Hemangi",date(2002,4,29),"Computer","2030331245019",2,9.68)
    stud2=student("Mokshada",date(2002,11,26),"Computer","2030331245023",2,9.65)
    stud3=student("Devyani",date(2002,7,18),"IT","2030331246026",2,8.5)
    stud4=student("Nikita",date(2002,11,3),"Computer","2030331245025",2,7.1)
    stud5=student("Mansi",date(2002,5,20),"IT","2030331246032",2,4.5)
